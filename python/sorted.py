...
# Оскільки логіка сортування всередині функції невелика і вкладається в один рядок,
# то лямбда-функція використовується всередині параметра key, а не передається як окреме ім’я функції.
