# Копіювання множини. Метод copy() використовується для дублювання множини.
tech_companies = ['Apple', 'Google', 'Samsung']

phone_manufacturers = tech_companies.copy()

print(phone_manufacturers)
...
# Метод issubset та issuperset перевіряє входження елементів множини в послідовності,
# якою може бути інша множина, список, кортеж. Метод повертає булеве значення - True або False.
# У параметрі вказуємо послідовність, з якою хочемо порівняти елементи множини.

A = {2, 1, 6, 3, 5, 14}  # Перша множина

B = {1, 2, 6}  # Друга множина

# Перевіряємо чи входить множина В до складу множини А (підмножина)
res = B.issubset(A)
# Перевіряємо чи є множина А супермножиною, що містить множину В
res2 = A.issuperset(B)
