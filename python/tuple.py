...
# приймає кортежі і повертає кількість елементів, що містяться всередині
print(len(t2))
print(t1)
print(t2)
...
# Кортеж може містити списки, словники як елементи. Їх можна змінювати всередині кортежу:
...
users[1]['user_id'] = 2  # Змінюємо словник
